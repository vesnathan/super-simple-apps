    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        >
          ...
          Back to Image Resize
        </Link>

        <h1 className="text-3xl font-bold text-gray-800 mb-6">
          About Super Simple Image Resize
        </h1>

        <div className="prose prose-lg text-gray-600 space-y-6">
          <p>
            Super Simple Image Resize is a free, privacy-focused tool that lets you
            resize and scale images directly in your browser. No uploads, no
            accounts, no waiting.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Resize by percentage, exact dimensions, or presets</li>
            <li>Maintain aspect ratio option</li>
            <li>Adjust output quality for smaller file sizes</li>
            <li>Convert between formats (JPEG, PNG, WebP)</li>
            <li>Common presets for social media and web</li>
            <li>Download resized images instantly</li>
            <li>Send to Image Crop for further editing</li>
          ...
          <h2 className="text-xl font-semibold text-gray-800 mt-8 mb-4">
            Works with Image Crop
          </h2>
          <p>
            Super Simple Image Resize integrates seamlessly with{" "}
            <a
            ...
            . After cropping an image, you can send it directly to this tool
            for resizing, and vice versa.
          </p>
          ...
          <p>
            Super Simple Image Resize is part of the{" "}
            <a
