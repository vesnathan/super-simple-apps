...
export const MainLayout: React.FC<MainLayoutProps> = ({ children, sidebarContent, onCreateInvoice }) => {
    ...
    <>
      ...
      <header className="md:hidden fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200 shadow-sm">
        <div className="flex items-center justify-between px-4 h-14">
          ...
          <a href="/" className="text-lg font-semibold text-gray-800 hover:text-green-600 transition-colors">
            Invoice
          </a>
